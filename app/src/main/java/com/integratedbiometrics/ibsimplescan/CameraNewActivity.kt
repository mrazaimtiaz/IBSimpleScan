...
import com.integratedbiometrics.ibsimplescan.utils.Constants.picture
import java.io.File
    ...
    private fun takePhoto() {
        ...
        imageCapture.takePicture(outputOptions, ContextCompat.getMainExecutor(this), object : ImageCapture.OnImageSavedCallback {
            override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
               ...
               picture = bitmap
                 val intent = Intent(this@CameraNewActivity, IrisActivity::class.java)
                // Start the new activity
                startActivity(intent)


                //    Toast.makeText(this@CameraNewActivity, "Photo saved: $savedUri", Toast.LENGTH_SHORT).show()
            }

            override fun onError(exception: ImageCaptureException) {
                Log.e("MainActivity", "Photo capture failed: ${exception.message}", exception)
                Toast.makeText(this@CameraNewActivity, "Photo capture failed.", Toast.LENGTH_SHORT).show()
            }
        })
    }
